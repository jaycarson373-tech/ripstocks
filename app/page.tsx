...
const MEMEPACKS_MINT=(process.env.NEXT_PUBLIC_MEMEPACKS_MINT||"37AcBRffKsHFFuUMfPi7HHZt16uok6LbN5GrFiJcpump").trim();
  ...
  return (
    <main>
      ...
      <nav className="nav wrap">
        ...
        <div className="navlinks"><a href="#packs">Packs</a><a href="#live">Live pulls</a><a href="#flywheel">How it works</a><a href="https://x.com/MemePacks_" target="_blank" rel="noreferrer">X ↗</a></div>
      ...
      <section className="hero wrap" id="top">
        <div className="heroCopy">
          <div className="eyebrow"><span /> SERIES 001 · POWERED BY $PACKS</div>
      ...
      <section className="fly wrap" id="flywheel"><span className="kicker">HOW IT RIPS</span><h2>Open. Pull.<br/><em>Repeat.</em></h2><div className="protocolSteps">{[["01","CONNECT","Connect Phantom or Backpack."],["02","RIP","Open one Series 001 pack for 10 USDC."],["03","REVEAL","Watch your actual meme artwork break through the foil."],["04","RECEIVE","Your pull lands directly in your wallet."],["05","HOLD $PACKS",`Hold $PACKS to enter funded $1–$3 holder draws every ${AIRDROP_INTERVAL_MINUTES} minutes.`]].map(s=><div className="hourStep" key={s[0]}><b>{s[0]}</b><span>{s[1]}</span><p>{s[2]}</p></div>)}</div>
      ...
      <footer><div className="wrap"><div className="brand brandImage"><img src="/memepacks-logo.jpg" alt=""/><span>MEME<em>PACKS</em></span></div><p>$PACKS · OPEN. PULL. REPEAT.</p><div className="footerLinks"><a href="https://x.com/MemePacks_" target="_blank" rel="noreferrer">X</a>{MEMEPACKS_MINT&&<><a href={`https://dexscreener.com/solana/${MEMEPACKS_MINT}`} target="_blank" rel="noreferrer">DEXSCREENER</a><a href={`https://pump.fun/coin/${MEMEPACKS_MINT}`} target="_blank" rel="noreferrer">TOKEN PAGE</a><a className="footerBuy" href={`https://jup.ag/?sell=So11111111111111111111111111111111111111112&buy=${MEMEPACKS_MINT}`} target="_blank" rel="noreferrer">BUY $PACKS</a></>}</div><span>BUILT ON SOLANA ◈</span></div></footer>
